...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th>goodsClassfiy.Data.add(ClassifyPo clas);</th>
<th colspan="2">增加一个商品分类</th> </tr>
<tr><th>goodsClassfiy.Data.find(String className);</th>
<th colspan="2">查找一个商品分类</th> </tr>
<tr><th>goodsClassfiy.Data.delete(ClassifyPo clas);
<th colspan="2">删除一个商品分类</th> </th></tr>
<tr><th>goodsClassfiy.Data.modify(ClassifyPo clas);</th>
<th colspan="2">修改一个商品分类</th> </tr>
</table>
...
<tr>
		...
		<th>语法</th>
		<th>public ArrayList<OrderPO> personFind(String personname)</th>
		</tr>
		<tr>
			<th>前置条件</th>
...
<tr>
		...
		<th>语法</th>
		<th>public ArrayList&lt;GoodsVo&gt;find(String number, String name, String type);</th>
		</tr>
		<tr>
			<th>前置条件</th>
			<th>数据库存在此关键字的商品</th>
...
<tr><th colspan="4">需要的服务（需接口)</th></tr>
<tr><th>服务名</th><th colspan="2">服务</th>
<tr><th>goodsClassfiy.Data.add(GoodsPo goods);</th>
<th colspan="2">增加一个商品分类</th> </tr>
<tr><th>goodsClassfiy.Data.find(String goodsName);</th>
<th colspan="2">查找一个商品分类</th> </tr>
<tr><th>goodsClassfiy.Data.delete(GoodsPo goods);
<th colspan="2">删除一个商品分类</th> </th></tr>
<tr><th>goodsClassfiy.Data.modify(GoodsPo goods);</th>
<th colspan="2">修改一个商品分类</th> </tr>
</table>
