...
<table>
	...
	<tr align="left">
		<th>参与者</th>
		<th colspan="3">进货销售人员，目标是记录下进货和退货数据，修改保存，生成单据，不要因为货源不匹配造成业务损失</th>
	<tr align="left">
		<th>触发条件</th>
		<th colspan="3">进货销售人员进货或进货销售人员
		向供货商退货</th>
	</tr>
	<tr align="left">
		<th>前置条件</th>
	...
	<tr align="left">
		<th>后置条件</th>
		<th colspan="3">a.系统根据进货状况给
		出进货单属性，包括单据编号，供应商，仓库
		，操作员，入库商品列表，备注，总额合
		计通过审批后系统更改库存数据和客户应收应付数据
		<br>b.系统根据退货状况给出退货单属性，与进货单属性一致
		<br>通过审批后系统更改库存数据和供应商应收应付数据		</th>
	</tr>
	<tr align="left">
		<th>优先级</th>
		<th colspan="3">中</th>
	...
	<tr align="left">
		...
		<th colspan="3">
			<ol>
				...
				和客户应收应付数据		
				<li>进货销售人员退货</li>
				<li>重复1~4步直到进货销售人员完成所有的退货工作				并更改数据
...
<table>
	...
	<tr align="left">
		<th>参与者</th>
		<th colspan="3">进货销售人员，目标是快速记录下销售数据	和销售退货数据，生成单据，修改保存，不要因为销售货源不匹配造成业务损失</th>
	<tr align="left">
		<th>触发条件</th>
		<th colspan="3">销售人员向客户销售商品或
		客户向销售人员退货</th>
	</tr>
	<tr align="left">
		<th>前置条件</th>
	...
	<tr align="left">
		<th>后置条件</th>
		<th colspan="3">a.销售系统给出销售单属性信息，包括单据编号，客户，业务员，操作员，仓库，出货商品清单，折让前总金额，折让，使用代金券金额，折让后总金额，备注；销售单通过审批后更改库存数据和客户的应收应付数据
		<br>b.销售系统给出销售退货单属
		性信息，与销售单属性一致</th>
	</tr>
	<tr align="left">
	...
	<tr align="left">
		...
		<th colspan="3">
			<ol>
				...
				<li>系统自动计算生成未手动输入部分</li>
			重复1~5步直到销售人员完成所有销售单	
			<li>销售单通过审批后系统更改数据并保存
			<li>客户向销售人员退货</li>
			<li>系统给出新建的退货单，给出和销售单一致的属性
			<br>返回正常流程第4步
			<br>重复7~8步直到完成所有的客户完成所有的退货工作
			<li>销售退货单通过审批后系统更改数据并保存</li>	</th>
	</tr>
	<tr align="left">
		<th>扩展流程</th>
...
<table>
	...
	<tr align="left">
		...
		显示收款属性和付款属性，更改数据并保存</th>
	<tr align="left">
		<th>触发条件</th>
		<th colspan="3">a.财务人员收款并填
		写属性信息，包括操作员，转账列表，总额汇总
		<br>b.财务人员
		付款并填写属性信息，属性和收款一致</th>
	</tr>
	<tr align="left">
		<th>前置条件</th>
		<th colspan="3">财务人员已经被识别和授权</th>
	...
	<tr align="left">
		...
		<th colspan="3">
			<ol>
				...
				<li>收款单据编号格式XJFYD-yyyyMMdd-xxxx</li>
		</th>
	</tr>
</table>
